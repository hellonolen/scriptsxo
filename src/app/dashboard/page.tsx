    ...
    return (
      <AppShell>
        <div className="p-6 lg:p-10 max-w-[1400px]">
          ...
          <div className="glass-card py-12 px-8 lg:p-16 relative overflow-hidden">
            {/* Background flourish */}
            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-brand-secondary/5 blur-[100px] rounded-full pointer-events-none -translate-y-1/2 translate-x-1/2" />
            ...
            <div className="relative z-10 max-w-xl">
              ...
              <h2 className="text-3xl lg:text-4xl font-light text-foreground mb-4" style={{ fontFamily: "var(--font-heading)" }}>
                Start Your Health Journey
              </h2>
              <p className="text-base text-muted-foreground font-light mb-10 leading-relaxed max-w-md">
                Complete your intake to unlock unlimited prescriptions, telehealth consultations, and personalized care.
              </p>
              <Link
                href="/dashboard/order"
                className="inline-flex items-center gap-3 px-8 py-4 text-white text-xs tracking-[0.15em] uppercase font-light rounded-xl shadow-[0_4px_14px_0_rgba(124,58,237,0.3)] hover:shadow-[0_6px_20px_rgba(124,58,237,0.23)] transition-all bg-brand-secondary"
              >
                New Order
                <ArrowRight size={16} />
              </Link>
  ...
  return (
    <AppShell>
      <div className="p-6 lg:p-10 max-w-[1400px]">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-[1fr_380px] xl:grid-cols-[1fr_420px] gap-8">
