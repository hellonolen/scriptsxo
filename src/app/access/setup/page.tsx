...
const ACCESS_PATHS = [
  {
    ...
    label: "Client Access",
    description:
      "Receive telehealth consultations and prescription fulfillment. Requires government-issued ID and payment verification.",
    icon: UserCheck,
  },
  {
  ...
  },
  {
    ...
    description:
      "Pharmacy operators for prescription fulfillment. Requires NCPDP number and pharmacy NPI verification.",
    icon: Package,
  },
] as const;
        ...
        <div className="relative z-10 flex flex-col justify-between p-16 xl:p-24 w-full">
          ...
          <div className="max-w-lg">
            ...
            <p className="text-white/50 text-base font-light leading-relaxed mt-10 max-w-sm">
              Access is granted after your credentials are verified. Select the
              path that applies to you to begin.
            </p>
          </div>
                  ...
                  <div className="flex items-start gap-4">
                    <div
                      className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                        isSelected ? "bg-[#7C3AED]/10" : "bg-muted"
                      }`}
                    >
                      <Icon
                        size={18}
